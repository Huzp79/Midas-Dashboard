...
## 16. CURRENT STATUS (ณ 21 พฤษภาคม 2026)
...
🔴 P1: แก้ Entry ช้า — Pre-Trade Brief Logic
   ปัญหา: ราคาเข้า Zone แล้ว แต่ระบบปลุก Midas ช้าเพราะรอ Sweep ครบก่อน
   แนวทาง: ปลุก Midas ทันทีเมื่อ Squeeze ON + ราคาอยู่ใน OB
   ไม่ต้องรอ Sweep + Histogram ครบทุกข้อก่อน

🔴 P2: Telegram แจ้งตอนปิดไม้ + บันทึก Journal อัตโนมัติ
   ปัจจุบัน: แจ้งแค่ตอนเปิดไม้ ไม่รู้ว่าปิดที่ไหน
   ต้องการ: STATE 4 MONITORING ตรวจพบ TP/SL Hit → Telegram + Journal

🟡 P3: CME Data ใน Hermes
   ดึง CME Basis + เขียนลง CME_Daily.md
   ใช้ประกอบ Institutional Bias ใน Morning Brief

🟡 P4: แก้ Entry Price ใน Telegram Alert
   ปัจจุบัน: Entry ที่ส่งไป Telegram อาจไม่ตรงกับราคาที่ Execute จริง
   ต้องการ: ดึง fill price จริงจาก MT5 หลัง Execute
