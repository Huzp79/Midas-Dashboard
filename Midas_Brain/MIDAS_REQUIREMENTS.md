...
## 16. CURRENT STATUS (ณ 22 พฤษภาคม 2026 — v3.0)
...
✅ start_midas.bat เปิดทุกอย่างด้วย Double Click
   (Chrome debug port 9222 → รอ 3 วิ → CMD รัน main.py)
...
🟢 P4: Live Trade เมื่อ Demo Win Rate ≥ 45%
   เปลี่ยนจาก Demo → Live เมื่อผ่านเกณฑ์ Win Rate ≥ 45% และ RR เฉลี่ย ≥ 1:3
```
